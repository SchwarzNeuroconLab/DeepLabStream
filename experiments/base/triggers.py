...
class BaseEgoHeaddirectionTrigger(BaseTrigger):
    ...
    def check_skeleton(self, skeleton: dict):
        ...
        """
        ret_head_dir, angle = angle_between_vectors(*skeleton[self._bodyparts[0]], *skeleton[self._bodyparts[1]], *skeleton[self._bodyparts[2]])
        true_angle = abs(angle)
...
class BaseScreenTrigger(BaseTrigger):
    ...
    def check_skeleton(self, skeleton: dict):
        ...
        head_dir, angle = angle_between_vectors(direction_x, direction_y, *skeleton[self._bodyparts[0]], *skeleton[self._bodyparts[1]])
        ...
        color = (0, 255, 0) if result else (0, 0, 255)
        if self._debug:
            response_body = {'plot': {'line': dict(pt1=skeleton[self._bodyparts[0]],
                                                   pt2=self._point,
                                                   color=color),
...
class BaseHeaddirectionROITrigger(BaseTrigger):
    ...
    def check_skeleton(self, skeleton: dict):
        ...
        ret_head_dir, angle = angle_between_vectors(*skeleton[self._angle_bodyparts[0]], *skeleton[self._angle_bodyparts[1]], *self._point)
        true_angle = abs(angle)
